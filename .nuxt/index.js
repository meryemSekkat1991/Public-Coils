...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {"title":"CoilsFront","htmlAttrs":{"lang":"en"},"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":""}],"link":[{"rel":"icon","type":"image\u002Fx-icon","href":"\u002Ffavicon.ico"}],"style":[],"script":[]},
  ...
  if (typeof nuxt_plugin_plugin_c47644b2 === 'function') {
  ...
  if (typeof nuxt_plugin_auth_0ae5c253 === 'function') {
    await nuxt_plugin_auth_0ae5c253(app.context, inject)
  }
